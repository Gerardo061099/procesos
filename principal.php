...
<div class="container-principal">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            <ul class="menu-lista">
                <li class="options"><a href="#" class="links"><i class="fa-solid fa-house"></i>  Inicio</a></li>
    ...
    <div>
        <h1 id="text">Bienvenido!!</h1>
    </div>
</div>
<div class="container-p">
    <div class="container-p-a">
        <h3><center>Porcentaje de trabajadores por area</center></h3>
        <canvas id="circulo1"></canvas>
    </div>
    <div class="container-p-b">
        <h3><center>Resumen Fundicion 1</center></h3>
